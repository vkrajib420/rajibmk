...
'''
this is an open source program by Mr. King (Rajib-Vau)
...
try:
    ...
    import mechanize
    import bs4
    from requests.exceptions import ConnectionKing
except ModuleNotFoundKing:
...
def random_number():
	...
	if len(fkode) < 10:
		xox(f'\n{M} King! MAYBE YOU PUT THE WRONG NUMBER ')
		time.sleep(2)
		random_number()
	else:
		pass
